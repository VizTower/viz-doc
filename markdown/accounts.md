...
| Ключ            | Разрешения                                                   |
| ------------------------- | ------------------------------------------------------------ |
| Регулярный (regular)      | Отправка [custom-транзакций](./glossary.html#custom-transaction), награждение пользователей, изменение метаданных аккаунта, любые действия с [комитетом.](./economy.html#committee) |
| Активный (active)         | Всё, что можно делать с помощью регулярного ключа, а также операции с [активами](./economy.html#assets) и голосование за [делегатов](./witnesses.html). |
