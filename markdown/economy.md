...
где ``SUM`` - математическая сумма, ``Wn`` - количество shares участника ``n``, ``Pn`` - процент, который выставил участник ``n``, ``M`` - максимальная  сумма [ликвидных токенов](#viz-token), которую указал создатель заявки.