...
.. note:: 
    Примечание: проценты, указанные выше, были установлены по умолчанию во время первого запуска сети. Но их в любой момент могут изменить :ref:`делегаты <./witnesses.html#props>`.
